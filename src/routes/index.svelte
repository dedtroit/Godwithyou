	...
	<div class="content">
		...
		<div class="hero">
			...
			<div class="subheadcolr">
				<h2 class="h2">
					enter your prayer request and we WILL pray for you
				</h2>
				<h3>
					we do not track your information. check the html with f12
					button if you need to verify
				</h3>
			</div>
		</div>
		<div class="spacer" />
		...
		<form on:submit|preventDefault={submitForm} class="form">
			...
			<label for="phone" class="phone"
				>want to be called for prayer?</label
			>
