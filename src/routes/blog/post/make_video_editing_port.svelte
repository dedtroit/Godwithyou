...
<div class="hero">
    <div class="headercolr"><h1>Make a video<br />editing porfolio</h1></div>
    <div class="subheadcolr">
        <h2>In adobe premiere without any footage</h2>
        <h3>4 minute read</h3>
        <h4>
            by Danny Matthews / <a
                class="textdecor"
...
<div class="video">
    <iframe
        ...
        src="https://www.youtube.com/embed/idh5Ms_Vank?autoplay=1&controls=1&rel=0&showinfo=0&autohide=1&mute=0"
